...
from graph import create_graph, analyze_centrality, visualize_graph, measure_execution_time, plot_info_table, cluster_graph_louvain, feature_importance_analysis, plot_feature_importance, calculate_statistics, display_statistics, find_most_successful_movie, find_connected_movies, analyze_connection_factors, plot_successful_movie_connections, remove_nodes_without_connections, plot_connection_factors_table, analyze_communities, calculate_average_degree
...
def main():
    ...
    df_filtered, scaler = measure_execution_time(preprocess_data, df.copy(), 0, 300)  # Ajuste os limiares conforme necessário
